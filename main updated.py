...
frame1 = Frame(root, bg='azure', bd=8)
frame1.place(relx=0.15, rely=0.05, relwidth=0.7, relheight=0.1)
label1 = Label(frame1, text="QR Code Generator", bg='azure', font="Times 20 bold")
...
label2 = Label(frame2, text="Enter the text/URL: ", bg="SteelBlue", fg='azure', font="Courier 13 bold")
...
label3 = Label(frame3, text="Enter the name of the QR Code", bg="SteelBlue", fg='azure', font="Courier 13 bold")
...
label4 = Label(frame4, text="Enter the size from 1 to 40:", bg="SteelBlue", fg='azure', font='Courier 13 bold')
...
button = Button(root, text="Generate Code", font='Courier 15 normal', command=code)
button.place(relx=0.15, rely=0.9, relwidth=0.25, relheight=0.05)
button2 = Button(root, text="Read Code", font="Courier 15 normal", command=read)
button2.place(relx=0.55, rely=0.9, relwidth=0.25, relheight=0.05)
root.mainloop()